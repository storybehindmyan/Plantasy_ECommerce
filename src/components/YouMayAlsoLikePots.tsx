                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div className="relative group overflow-hidden h-[400px]">
                        ...
                        <div className="absolute inset-0 p-8 flex flex-col justify-end items-start text-white">
                            <h3 className="text-3xl font-serif mb-2 leading-tight text-white">Plants Collection</h3>
                    ...
                    <div className="relative group overflow-hidden h-[400px]">
                        ...
                        {/* Content Overlay */}
                        <div className="absolute inset-0 p-8 flex flex-col justify-end items-start text-white">
                            <h3 className="text-3xl font-serif mb-2 leading-tight text-white">Seeds Collection</h3>
